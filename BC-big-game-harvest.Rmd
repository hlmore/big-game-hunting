...
# ~paste(sep = "<br/>",
#                              paste("<b>WMU # ", WILDLIFE_MGMT_UNIT_ID, "</b>",
#                                    sep = ''),
#                              paste(format(
#                                round(as.numeric(FEATURE_AREA_SQM/(1000^2)), 1), 
#                                nsmall = 1, 
#                                big.mark = ","
#                                ), "km^2"),  # https://stackoverflow.com/a/29465942
#                              paste("Game management zone: ", GAME_MANAGEMENT_ZONE_ID, 
#                                    " (", GAME_MANAGEMENT_ZONE_NAME, ")",
#                                    sep = ''),
#                              paste("Hunting region: ", REGION_RESPONSIBLE, 
